...
def split_sheet_image_into_move(sheet_image_path, out_dir_path):
    # load data
    ...
    # FIXME limit upto args.move_num
...
def main(args):
    split_sheet_image_into_move(args.input, args.output)
...
if __name__ == '__main__':
    ...
    # TODO: add move_num to limit output
    # parser.add_argument('--move_num', default=60)
